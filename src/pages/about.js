...
import bannerImage from "images/about-banner-opt1.jpg"
import mobileImage from "images/about-mobile.jpg"
      ...
      >
        <div className="pad">
          ...
          <p>
            ...
            uploaded for others to use on their profiles. This was the first
            step on the path for knowledge in HTML, CSS/SCSS and JavaScript.
            Keeping up with JavaScript libraries such as jQuery, React, gsap and
